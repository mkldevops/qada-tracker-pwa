...
function PrayerRow({ prayer, remaining, totalOwed, totalCompleted, onLog }: {
  prayer: PrayerName;
  remaining: number;
  totalOwed: number;
    ...
    >
      <div className="flex flex-1 flex-col gap-1.5">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs" style={{ color: '#4A4A4C' }}>{cfg.labelAr}</span>
    ...
    <div className="space-y-5 px-7 pb-4 pt-1">
      <div className="flex items-start justify-between">
        <div className="flex flex-col gap-0.5">
          <h1 className="font-display text-3xl font-normal" style={{ color: '#F5F5F0' }}>قضاء</h1>
