	...
	},
	{
		...
		changes: {
			fr: [
				...
				'Store : gestion silencieuse des erreurs de synchronisation dans les setters',
			],
			en: [
				...
				'Tests: global localStorage reset between tests; store setters handle sync errors silently',
			],
		},
	},
	{
